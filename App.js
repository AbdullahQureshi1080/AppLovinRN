...
const App = () => {
  ...
  const [isProgrammaticBannerCreated, setIsProgrammaticBannerCreated] =
    useState(false);
  const [isProgrammaticBannerShowing, setIsProgrammaticBannerShowing] =
    useState(false);
  const [isNativeUIBannerShowing, setIsNativeUIBannerShowing] = useState(false);
  const [isProgrammaticMRecCreated, setIsProgrammaticMRecCreated] =
    useState(false);
  const [isProgrammaticMRecShowing, setIsProgrammaticMRecShowing] =
    useState(false);
  ...
  AppLovinMAX.initialize(SDK_KEY, configuration => {
    ...
    if (Platform.OS === 'android') {
      if (
        configuration.consentDialogState ==
        ...
        configuration.consentDialogState ==
        AppLovinMAX.ConsentDialogState.DOES_NOT_APPLY
      ) {
        ...
        <AppButton
          title={
            isNativeUIBannerShowing
              ? 'Hide Native UI Banner'
              : 'Show Native UI Banner'
          }
